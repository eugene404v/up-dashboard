...
import { useCreateJetAmenityMutation } from 'redux/ducks/amenities/amenitiesApi'
...
type propsType = {
   ...
   onDeselect: (id: number, type: amenitiesJetTypeEnum & amenitiesYachtTypeEnum) => void;
   onClose: () => void;
   type: amenitiesJetTypeEnum & amenitiesYachtTypeEnum; //
}

function JetAmenitiesModal({ title = "Удобства / Оборудование", data, selectedData, onClose, onDeselect, onSelect, type}: propsType) {
    const [filteredData, setFilteredData] = React.useState(data)
    const [inputValue, setInputValue] = React.useState("")
    const [ createAmenity, result ] = useCreateJetAmenityMutation()
...
export default JetAmenitiesModal
