...
import { useCreateYachtManufacturerMutation } from 'redux/ducks/manufacturers/manufacturersQuery'
...
function AddProducerModal({onClose, onBack}: propsType) {
    const [createYachtManufacturer, result] = useCreateYachtManufacturerMutation()

    const submitHandler = (vals:{name: string}) => {
        createYachtManufacturer(vals.name)
    }
